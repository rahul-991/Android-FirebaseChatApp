...
public abstract class FirebaseObjectListAdapter<T> extends BaseAdapter
{
     ...
     */
    public FirebaseObjectListAdapter(Activity activity, Class<T> modelClass, int modelLayout, Query ref) {
    ...
    public FirebaseObjectListAdapter(Activity activity, Class<T> modelClass, int modelLayout, DatabaseReference ref) {
    ...
    protected T parseSnapshot(DataSnapshot snapshot) {
        Log.e("Bloodyshit", snapshot.toString());
